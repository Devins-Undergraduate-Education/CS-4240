...
public class tigerLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"MAIN", "ARRAY", "BREAK", "DO", "IF", "ELSE", "FOR", "FUNCTION", "LET", 
			"IN", "OF", "THEN", "TO", "VAR", "WHILE", "ENDIF", "BEGINKW", "END", 
			"ENDDO", "RETURN", "INT", "FLOAT", "PLUS", "MINUS", "MULT", "DIV", "EQ", 
			"NEQ", "LT", "GT", "LE", "GE", "AND", "OR", "ASSIGN", "COMMA", "COLON", 
			"SEMI", "LPAREN", "RPAREN", "LBRACK", "RBRACK", "FLOATLIT", "INTLIT", 
